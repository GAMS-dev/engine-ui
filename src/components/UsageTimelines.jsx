...
const UsageTimeline = () => {
    const { data, isLoading: dataIsLoading, startDate, endDate } = useOutletContext();
    ...
    useEffect(() => {
        const computeChartData = () => {
            ...
            setIsLoading(true);
            const dataDisaggregatedTmp = data.job_usage.concat(data.hypercube_job_usage);
    ...
    return (
        <>{dataIsLoading ? <ClipLoader /> : <div className="mt-3">
            ...
            {isLoading ? <ClipLoader /> : <>
                ...
                <Table data={aggregated ? dataAggregated : dataDisaggregated}
