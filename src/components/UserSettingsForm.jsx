...
const UserSettingsForm = () => {
  ...
  const [selectedTablePageLength, setSelectedTablePageLength] = useState(
    userSettings.tablePageLength,
  );
  const [webpushSettingsJSON, setWebpushSettingsJSON] = useState(
  ...
  return (
    <div>
      ...
      <Tab.Content>
        <Outlet
          context={{
            selectedTablePageLength,
            setSelectedTablePageLength,
