    ...
    <>
      <li className="nav-item">
        ...
        >
          ...
          <Dropdown.Menu>
            <Dropdown.Item as={Link} to={`/users/${username}`}>
              <small>Usage</small>
            </Dropdown.Item>
            <Dropdown.Item as={Link} to="/settings">
              <small>Settings</small>
            </Dropdown.Item>
            <Dropdown.Item as={Link} to="/auth-token">
              <small>Create auth token</small>
            </Dropdown.Item>
            {isIDPManaged !== true && (
              <Dropdown.Item as={Link} to={`/users/${username}/change_pass`}>
            ...
            <QuotaWidget
              ...
              className="dropdown-item dropdown-item-static small pe-none"
            />
          </Dropdown.Menu>
        </Dropdown>
      </li>
