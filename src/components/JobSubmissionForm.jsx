...
const JobSubmissionForm = props => {
    ...
    const updateUseRegisteredModel = e => {
        setUseRegisteredModel(e.target.checked);
    }
    const updateRegisteredModelName = e => {
        setRegisteredModelName(e.target.value);
    }
    ...
    const updateLogFileName = e => {
        setLogFileName(e.target.value);
    }
    const updateHcFile = e => {
        setHcFile(e.target.files[0]);
    }
    const updateTextEntries = e => {
        setTextEntries(e.target.value);
    }
    const updateStreamEntries = e => {
        setStreamEntries(e.target.value);
    }
                        ...
                        <div className="col-md-6 col-12">
                            <fieldset disabled={isSubmitting}>
                                <div className="form-group">
                                    ...
                                    <select id="namespace" className="form-control" value={namespace} onChange={updateNamespace}>
                                        {availableNamespaces.map(ns => <option key={ns.name} value={ns.name}>{ns.name}</option>)}
                                    </select>
                                </div>
                                <div className="form-check mb-3">
                                    <input type="checkbox" className="form-check-input" checked={useRegisteredModel} onChange={updateUseRegisteredModel}
                                ...
                                {useRegisteredModel && registeredModels.length !== 0 ?
                                    <div className="form-group">
                                        ...
                                        <select id="registeredModelName" className="form-control" value={registeredModelName} onChange={updateRegisteredModelName}>
                                            ...
                                            <>
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <input
                                                        ...
                                                        autoComplete="on"
                                                        value={streamEntries}
                                                        onChange={updateStreamEntries}
                                                    />
                                                </div>
                                            </>
                                        }
                                        <InexJSONSelector onChangeHandler={updateInexJSON} />
                                    </div>
                                </Collapse>
                            </fieldset>
                        </div>
