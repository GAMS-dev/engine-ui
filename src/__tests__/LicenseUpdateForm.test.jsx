...
describe('LicenseUpdateForm', () => {
  ...
  it('renders LicenseUpdateForm correctly', async () => {
    ...
    await waitFor(() =>
      screen.findByText(/User does not have and does not inherit any license/),
    );
  });
  ...
  it('shows error correctly if other problems occur in get', async () => {
    ...
    await waitFor(() =>
      screen.findByText(
        /Problems while retrieving user license. Error message: some error./,
      ),
    );
  });
  ...
  it('handles errors of submit correctly', async () => {
    ...
    await waitFor(() =>
      screen.findByText(
        /An error occurred while updating user license. Error message: some error occurred./,
      ),
    );
  });
