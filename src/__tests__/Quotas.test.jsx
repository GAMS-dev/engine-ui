...
describe('Quotas with single job', () => {
  ...
  it('renders Quotas component for single job', () => {
    render(getQuotaComponent({ data: testData, startDate, endDate }), {
...
describe('test cases in calculateQuota', () => {
  ...
  it('cases in calculateQuota work', () => {
    render(
      getQuotaComponent({
        data: testData,
        startDate: new Date('2021-08-03T17:10:15.000000+00:00'),
        endDate: new Date('2021-08-05T17:10:15.000000+00:00'),
      }),
      {
        wrapper: AllProvidersWrapperDefault,
      },
