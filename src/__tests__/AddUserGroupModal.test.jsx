...
describe('AddUserGroupModal', () => {
  ...
  it('sends the correct request', async () => {
    ...
    expect(axios.post).toBeCalledWith(
      'testserver/namespaces/testNamespace/user-groups',
      null,
  ...
  it('closes and does not call put if canceled', async () => {
    ...
    render(
      <AddUserGroupModal showDialog={true} setShowDialog={mockSetShowDialog} />,
      {
        wrapper: AllProvidersWrapperDefault,
      },
    );
  ...
  it('displays error message if put does not work', async () => {
    ...
    expect(
      screen.getByText(
        'Some error occurred. Error message: some error occurred.',
      ),
    ).toBeInTheDocument();
  });
