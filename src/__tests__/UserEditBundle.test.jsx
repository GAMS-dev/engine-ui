...
import UsageTimeline from '../components/UsageTimelines';
...
const getUserToEditComponent = () => {
  return (
    <Routes>
      <Route path="/" element={<UserEditBundle />}>
...
describe('UserEditBundle', () => {
      ...
      switch (url) {
        case 'testserver/usage/':
          return Promise.resolve({
            status: 200,
            data: testDatax.test_single_job,
          });
  ...
  it('opens the correct tap, dependent on the given path: /usage/dashboard', async () => {
    render(getUserToEditComponent(), {
      wrapper: ({ children }) => (
        <AllProvidersWrapperDefault
          options={{ initialEntries: ['/usage/dashboard'] }}
        >
          {children}
        </AllProvidersWrapperDefault>
      ),
  ...
  it('opens the correct tap, dependent on the given path: /usage/timeline', async () => {
    render(getUserToEditComponent(), {
      wrapper: ({ children }) => (
        <AllProvidersWrapperDefault
          options={{ initialEntries: ['/usage/timeline'] }}
        >
          {children}
        </AllProvidersWrapperDefault>
      ),
  ...
  it('opens the correct tap, dependent on the given path: /change_pass', async () => {
    render(getUserToEditComponent(), {
      wrapper: ({ children }) => (
        <AllProvidersWrapperDefault
          options={{ initialEntries: ['/change_pass'] }}
        >
          {children}
        </AllProvidersWrapperDefault>
      ),
  ...
  it('opens the correct tap, dependent on the given path: /instances', async () => {
    render(getUserToEditComponent(), {
      wrapper: ({ children }) => (
        <AllProvidersWrapperDefault
          options={{ initialEntries: ['/instances'] }}
        >
          {children}
        </AllProvidersWrapperDefault>
      ),
  ...
  it('opens the correct tap, dependent on the given path: /identity_provider', async () => {
    render(getUserToEditComponent(), {
      wrapper: ({ children }) => (
        <AllProvidersWrapperDefault
          options={{ initialEntries: ['/identity_provider'] }}
        >
          {children}
        </AllProvidersWrapperDefault>
      ),
  ...
  it('opens the correct tap, dependent on the given path: /permissions', async () => {
    render(getUserToEditComponent(), {
      wrapper: ({ children }) => (
        <AllProvidersWrapperDefault
          options={{ initialEntries: ['/permissions'] }}
        >
          {children}
        </AllProvidersWrapperDefault>
      ),
  ...
  it('opens the correct tap, dependent on the given path: /invitees', async () => {
    vi.mocked(useParams).mockReturnValue({ userToEdit: 'admin' });
    render(getUserToEditComponent(), {
      wrapper: ({ children }) => (
  ...
  it('opens the correct tab after click', async () => {
    ...
    await waitFor(() => screen.findByText(/Change Password/));
  ...
  it('admin can see fewer options on inviter page with different provider', async () => {
    vi.mocked(useParams).mockReturnValue({ userToEdit: 'inviter1' });
    render(getUserToEditComponent(), {
      wrapper: ({ children }) => (
        <AllProvidersWrapperDefault options={{ initialEntries: ['/usage'] }}>
          {children}
  ...
  it('inviter can not see admin page', async () => {
    ...
    await waitFor(() =>
      screen.findByText(
        /You do not have permission to view information about user: admin./,
      ),
    );
  ...
  it('inviter can see user page for an invited inviter', async () => {
    isAuthorized = false;
    vi.mocked(useParams).mockReturnValue({ userToEdit: 'invited_by_inviter1' });
    render(getUserToEditComponent(), {
      wrapper: ({ children }) => (
        <AllProvidersWrapperDefault
          options={{
  ...
  it('user only sees usage on his own page', async () => {
    ...
    render(getUserToEditComponent(), {
      wrapper: ({ children }) => (
        <AllProvidersWrapperDefault
          options={{
            initialEntries: ['/usage/dashboard'],
            username: 'user1',
            roles: [],
          }}
        >
  ...
  it('user can not see page of non existing user', async () => {
    isAuthorized = false;
    vi.mocked(useParams).mockReturnValue({ userToEdit: 'notExisting' });
    render(getUserToEditComponent(), {
      wrapper: ({ children }) => (
        <AllProvidersWrapperDefault
          options={{
    ...
    await waitFor(() =>
      screen.findByText(/No data for user: notExisting found./),
    );
    expect(screen.queryByText(/Usage/)).toBeNull();
    expect(screen.queryByText(/Password/)).toBeNull();
    expect(screen.queryByText(/License/)).toBeNull();
